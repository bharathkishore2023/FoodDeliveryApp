    ...
    flex flex-col z-[101]'>
        ...
        {cartItems && cartItems.length>0 ? (
            ...
            <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col '>
                {/* cart items section */}
                <div className='w-full h-340 md:42 px-6 py-10 flex flex-col
            ...
            <div className='w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col
             items-center justify-evenly px-8 py-2'>
               ...
               {user ? (
                 ...
                 whileTap={{scale:0.8}}
                 type="button"
                 className='w-full p-2 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 text-gray-50 text-lg my-2
